...
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'ComputerShopDbV1')
BEGIN
    CREATE DATABASE ComputerShopDbV1;
    PRINT 'Database ComputerShopDbV1 created.';
END
ELSE
BEGIN
    PRINT 'Database ComputerShopDbV1 already exists.';
END
GO
