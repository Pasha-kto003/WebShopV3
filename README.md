...
**WebShopV3** — это полноценный веб-магазин, в котором пользователи (именно клиенты) могут:
...
- Возможность создать свою конфигурацию ПК
- Оплата заказа происходит через Юкассу
**Со стороны админской части было реализовано следующее:**
- Создавать, проводить и редактировать заказы пользователей
- Работа с компютерами, создавать новые, и редактировать существующие ПК
- Работа с характеристиками ПК
- Работа с комплектующими ПК
- Работа с пользователями создание/регистрация новых, редактирование существующих
- Ведение отчетности и статистики по текущему состоянию заказов
...
### ├── Program.cs # Главный класс сайта
